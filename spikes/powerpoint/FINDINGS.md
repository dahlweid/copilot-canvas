...
not quoted. Each was a single activation-inclusive result carried in from a
different spike under different conditions, so neither supports comparison with
the repeated PowerPoint ranges.
