...
try {
    ...
    # Protected View sandbox WINWORD the caller never bound to -- the "What this
    # deliberately does NOT measure" note in probe-init-attribution.ps1 records
    # why the read is early and what moving it would cost.
