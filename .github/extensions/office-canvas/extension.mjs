...
const createDocumentTool = {
    ...
    description: [
        ...
        "Text is written verbatim: it is assigned to a range rather than typed, so Word's autocorrect and",
        "autoformat-as-you-type do not fire on it — straight quotes stay straight and nothing is",
        "substituted or capitalised on the way in. Your own Word settings are never read and never",
        "changed, on any instance.",
    ].join(" "),
    parameters: {
        type: "object",
        properties: {
